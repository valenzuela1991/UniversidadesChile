#scrapy runspider DatosUTEMContrata.py
...
class UTEMContrata(Spider):
    ...
    start_urls = ['http://transparencia.utem.cl/personal-y-remuneraciones/personal-y-remuneraciones-personal-a-contrata/']

    def parse(self, response):
                milista=[]
                InfoTabla = response.xpath('//*[@id="tablepress-52"]/tbody').extract_first()
