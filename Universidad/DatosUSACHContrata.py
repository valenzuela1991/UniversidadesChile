#scrapy runspider DatosUSACHContrata.py
...
class UTEMContrata(Spider):
    ...
    start_urls = ['https://www.transparenciaactiva.usach.cl/contrata-septiembre-2018']

    def parse(self, response):
                milista=[]
                InfoTabla = response.xpath('//*[@id="node-page-1392"]/div[1]/div/div/div/table/tbody').extract_first()
